...
// multi hit search
        {"multihitdb",          multihitdb,            &par.multihitdb,           COMMAND_MULTIHIT,
                ...
                "<o:setDB> <i:fastaFile1[.gz]> ... <i:fastaFileN[.gz]>",
                CITATION_MMSEQS2},
        ...
        {"combinepvalperset",     combinepvalperset,     &par.combinepvalbyset,      COMMAND_MULTIHIT,
                ...
                CITATION_MMSEQS2},
        {"summarizeresultsbyset", summarizeresultsbyset, &par.summarizeresultsbyset, COMMAND_MULTIHIT,
                ...
                CITATION_MMSEQS2},
        {"resultsbyset",          resultsbyset,         &par.onlythreads,          COMMAND_HIDDEN,
                "For each set compute the combined p-value",
                NULL,
                "Clovis Norroy & Milot Mirdita <milot@mirdita.de>",
