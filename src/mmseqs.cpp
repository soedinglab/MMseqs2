...
// multi hit search
        {"multihitdb",          multihitdb,            &par.multihitdb,           COMMAND_MULTIHIT,
                ...
                "<o:multiHitSequenceDB> <i:fastaFile1[.gz]> ... <i:fastaFileN[.gz]>",
                CITATION_MMSEQS2},
        {"multihitsearch",       multihitsearch,       &par.multihitsearch,       COMMAND_MULTIHIT,
                ...
                NULL,
                "Clovis Norroy & Milot Mirdita <milot@mirdita.de>",
                "<i:multiHitSequenceDB> <i:multiHitSequenceDB> <o:multiHitResultDB> <tmpDir>",
                CITATION_MMSEQS2},
        {"aggregate",           aggregate,             &par.aggregate,            COMMAND_MULTIHIT,
                "Compute aggregated statistics for multi hit search result",
                NULL,
                "Clovis Norroy & Milot Mirdita <milot@mirdita.de>",
                "<i:queryDB> <i:targetDB> <i:multiHitResultDB> <o:aggregateDB>",
                CITATION_MMSEQS2},
...
// Utility tools to manipulate DBs
        ...
        {"mergedbs",             mergedbs,             &par.mergedbs,             COMMAND_DB,
                ...
                CITATION_MMSEQS2},
        {"mergeorfcontigs",      mergeorfcontigs,      &par.onlythreads,          COMMAND_DB,
                "Merge results from multiple orfs back to their respective contig",
                 NULL,
                 "Clovis Norroy & Milot Mirdita <milot@mirdita.de>",
                 "<i:resultDB> <i:setLookupDB> <o:resultDB>",
                CITATION_MMSEQS2},
