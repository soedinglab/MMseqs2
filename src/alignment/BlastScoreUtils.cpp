...
double BlastScoreUtils::blosum45_values[BLOSUM45_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.2291, 0.0924, 0.2514, 0.9113, -5.7, 0.389016, 0.17698},
        {13, 3, (double) INT2_MAX, 0.207, 0.049, 0.14, 1.5, -22, 0.389016, 0.17698},
        {12, 3, (double) INT2_MAX, 0.199, 0.039, 0.11, 1.8, -34, 0.389016, 0.17698},
        {11, 3, (double) INT2_MAX, 0.190, 0.031, 0.095, 2.0, -38, 0.389016, 0.17698},
        {10, 3, (double) INT2_MAX, 0.179, 0.023, 0.075, 2.4, -51, 0.389016, 0.17698},
        {16, 2, (double) INT2_MAX, 0.210, 0.051, 0.14, 1.5, -24, 0.389016, 0.17698},
        {15, 2, (double) INT2_MAX, 0.203, 0.041, 0.12, 1.7, -31, 0.389016, 0.17698},
        {14, 2, (double) INT2_MAX, 0.195, 0.032, 0.10, 1.9, -36, 0.389016, 0.17698},
        {13, 2, (double) INT2_MAX, 0.185, 0.024, 0.084, 2.2, -45, 0.389016, 0.17698},
        {12, 2, (double) INT2_MAX, 0.171, 0.016, 0.061, 2.8, -65, 0.389016, 0.17698},
        {19, 1, (double) INT2_MAX, 0.205, 0.040, 0.11, 1.9, -43, 0.389016, 0.17698},
        {18, 1, (double) INT2_MAX, 0.198, 0.032, 0.10, 2.0, -43, 0.389016, 0.17698},
        {17, 1, (double) INT2_MAX, 0.189, 0.024, 0.079, 2.4, -57, 0.389016, 0.17698},
        {16, 1, (double) INT2_MAX, 0.176, 0.016, 0.063, 2.8, -67, 0.389016, 0.17698},
};
...
double BlastScoreUtils::blosum50_values[BLOSUM50_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.2318, 0.112, 0.3362, 0.6895, -4.0, 0.389016, 0.17698},
        {13, 3, (double) INT2_MAX, 0.212, 0.063, 0.19, 1.1, -16, 0.389016, 0.17698},
        {12, 3, (double) INT2_MAX, 0.206, 0.055, 0.17, 1.2, -18, 0.389016, 0.17698},
        {11, 3, (double) INT2_MAX, 0.197, 0.042, 0.14, 1.4, -25, 0.389016, 0.17698},
        {10, 3, (double) INT2_MAX, 0.186, 0.031, 0.11, 1.7, -34, 0.389016, 0.17698},
        {9, 3, (double) INT2_MAX, 0.172, 0.022, 0.082, 2.1, -48, 0.389016, 0.17698},
        {16, 2, (double) INT2_MAX, 0.215, 0.066, 0.20, 1.05, -15, 0.389016, 0.17698},
        {15, 2, (double) INT2_MAX, 0.210, 0.058, 0.17, 1.2, -20, 0.389016, 0.17698},
        {14, 2, (double) INT2_MAX, 0.202, 0.045, 0.14, 1.4, -27, 0.389016, 0.17698},
        {13, 2, (double) INT2_MAX, 0.193, 0.035, 0.12, 1.6, -32, 0.389016, 0.17698},
        {12, 2, (double) INT2_MAX, 0.181, 0.025, 0.095, 1.9, -41, 0.389016, 0.17698},
        {19, 1, (double) INT2_MAX, 0.212, 0.057, 0.18, 1.2, -21, 0.389016, 0.17698},
        {18, 1, (double) INT2_MAX, 0.207, 0.050, 0.15, 1.4, -28, 0.389016, 0.17698},
        {17, 1, (double) INT2_MAX, 0.198, 0.037, 0.12, 1.6, -33, 0.389016, 0.17698},
        {16, 1, (double) INT2_MAX, 0.186, 0.025, 0.10, 1.9, -42, 0.389016, 0.17698},
        {15, 1, (double) INT2_MAX, 0.171, 0.015, 0.063, 2.7, -76, 0.389016, 0.17698},
};
...
double BlastScoreUtils::blosum62_values[BLOSUM62_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.3176, 0.134, 0.4012, 0.7916, -3.2, 0.389016, 0.17698},
        {11, 2, (double) INT2_MAX, 0.297, 0.082, 0.27, 1.1, -10, 0.389016, 0.17698},
        {10, 2, (double) INT2_MAX, 0.291, 0.075, 0.23, 1.3, -15, 0.389016, 0.17698},
        {9, 2, (double) INT2_MAX, 0.279, 0.058, 0.19, 1.5, -19, 0.389016, 0.17698},
        {8, 2, (double) INT2_MAX, 0.264, 0.045, 0.15, 1.8, -26, 0.389016, 0.17698},
        {7, 2, (double) INT2_MAX, 0.239, 0.027, 0.10, 2.5, -46, 0.389016, 0.17698},
        {6, 2, (double) INT2_MAX, 0.201, 0.012, 0.061, 3.3, -58, 0.389016, 0.17698},
        {13, 1, (double) INT2_MAX, 0.292, 0.071, 0.23, 1.2, -11, 0.389016, 0.17698},
        {12, 1, (double) INT2_MAX, 0.283, 0.059, 0.19, 1.5, -19, 0.389016, 0.17698},
        {11, 1, (double) INT2_MAX, 0.267, 0.041, 0.14, 1.9, -30, 0.389016, 0.17698},
        {10, 1, (double) INT2_MAX, 0.243, 0.024, 0.10, 2.5, -44, 0.389016, 0.17698},
        {9, 1, (double) INT2_MAX, 0.206, 0.010, 0.052, 4.0, -87, 0.389016, 0.17698},
};
...
double BlastScoreUtils::blosum80_values[BLOSUM80_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.3430, 0.177, 0.6568, 0.5222, -1.6, 0.389016, 0.17698},
        {25, 2, (double) INT2_MAX, 0.342, 0.17, 0.66, 0.52, -1.6, 0.389016, 0.17698},
        {13, 2, (double) INT2_MAX, 0.336, 0.15, 0.57, 0.59, -3, 0.389016, 0.17698},
        {9, 2, (double) INT2_MAX, 0.319, 0.11, 0.42, 0.76, -6, 0.389016, 0.17698},
        {8, 2, (double) INT2_MAX, 0.308, 0.090, 0.35, 0.89, -9, 0.389016, 0.17698},
        {7, 2, (double) INT2_MAX, 0.293, 0.070, 0.27, 1.1, -14, 0.389016, 0.17698},
        {6, 2, (double) INT2_MAX, 0.268, 0.045, 0.19, 1.4, -19, 0.389016, 0.17698},
        {11, 1, (double) INT2_MAX, 0.314, 0.095, 0.35, 0.90, -9, 0.389016, 0.17698},
        {10, 1, (double) INT2_MAX, 0.299, 0.071, 0.27, 1.1, -14, 0.389016, 0.17698},
        {9, 1, (double) INT2_MAX, 0.279, 0.048, 0.20, 1.4, -19, 0.389016, 0.17698},
};
...
double BlastScoreUtils::blosum90_values[BLOSUM90_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.3346, 0.190, 0.7547, 0.4434, -1.4, 0.389016, 0.17698},
        {9, 2, (double) INT2_MAX, 0.310, 0.12, 0.46, 0.67, -6, 0.389016, 0.17698},
        {8, 2, (double) INT2_MAX, 0.300, 0.099, 0.39, 0.76, -7, 0.389016, 0.17698},
        {7, 2, (double) INT2_MAX, 0.283, 0.072, 0.30, 0.93, -11, 0.389016, 0.17698},
        {6, 2, (double) INT2_MAX, 0.259, 0.048, 0.22, 1.2, -16, 0.389016, 0.17698},
        {11, 1, (double) INT2_MAX, 0.302, 0.093, 0.39, 0.78, -8, 0.389016, 0.17698},
        {10, 1, (double) INT2_MAX, 0.290, 0.075, 0.28, 1.04, -15, 0.389016, 0.17698},
        {9, 1, (double) INT2_MAX, 0.265, 0.044, 0.20, 1.3, -19, 0.389016, 0.17698},
};
...
double BlastScoreUtils::blosum62_20_values[BLOSUM62_20_VALUES_MAX][10] = {
        {(double) INT2_MAX, (double) INT2_MAX, (double) INT2_MAX, 0.03391, 0.125, 0.4544, 0.07462, -3.2, 0.389016, 0.17698},
        {100, 12, (double) INT2_MAX, 0.0300, 0.056, 0.21, 0.14, -15, 0.389016, 0.17698},
        {95, 12, (double) INT2_MAX, 0.0291, 0.047, 0.18, 0.16, -20, 0.389016, 0.17698},
        {90, 12, (double) INT2_MAX, 0.0280, 0.038, 0.15, 0.19, -28, 0.389016, 0.17698},
        {85, 12, (double) INT2_MAX, 0.0267, 0.030, 0.13, 0.21, -31, 0.389016, 0.17698},
        {80, 12, (double) INT2_MAX, 0.0250, 0.021, 0.10, 0.25, -39, 0.389016, 0.17698},
        {105, 11, (double) INT2_MAX, 0.0301, 0.056, 0.22, 0.14, -16, 0.389016, 0.17698},
        {100, 11, (double) INT2_MAX, 0.0294, 0.049, 0.20, 0.15, -17, 0.389016, 0.17698},
        {95, 11, (double) INT2_MAX, 0.0285, 0.042, 0.16, 0.18, -25, 0.389016, 0.17698},
        {90, 11, (double) INT2_MAX, 0.0271, 0.031, 0.14, 0.20, -28, 0.389016, 0.17698},
        {85, 11, (double) INT2_MAX, 0.0256, 0.023, 0.10, 0.26, -46, 0.389016, 0.17698},
        {115, 10, (double) INT2_MAX, 0.0308, 0.062, 0.22, 0.14, -20, 0.389016, 0.17698},
        {110, 10, (double) INT2_MAX, 0.0302, 0.056, 0.19, 0.16, -26, 0.389016, 0.17698},
        {105, 10, (double) INT2_MAX, 0.0296, 0.050, 0.17, 0.17, -27, 0.389016, 0.17698},
        {100, 10, (double) INT2_MAX, 0.0286, 0.041, 0.15, 0.19, -32, 0.389016, 0.17698},
        {95, 10, (double) INT2_MAX, 0.0272, 0.030, 0.13, 0.21, -35, 0.389016, 0.17698},
        {90, 10, (double) INT2_MAX, 0.0257, 0.022, 0.11, 0.24, -40, 0.389016, 0.17698},
        {85, 10, (double) INT2_MAX, 0.0242, 0.017, 0.083, 0.29, -51, 0.389016, 0.17698},
        {115, 9, (double) INT2_MAX, 0.0306, 0.061, 0.24, 0.13, -14, 0.389016, 0.17698},
        {110, 9, (double) INT2_MAX, 0.0299, 0.053, 0.19, 0.16, -23, 0.389016, 0.17698},
        {105, 9, (double) INT2_MAX, 0.0289, 0.043, 0.17, 0.17, -23, 0.389016, 0.17698},
        {100, 9, (double) INT2_MAX, 0.0279, 0.036, 0.14, 0.20, -31, 0.389016, 0.17698},
        {95, 9, (double) INT2_MAX, 0.0266, 0.028, 0.12, 0.23, -37, 0.389016, 0.17698},
        {120, 8, (double) INT2_MAX, 0.0307, 0.062, 0.22, 0.14, -18, 0.389016, 0.17698},
        {115, 8, (double) INT2_MAX, 0.0300, 0.053, 0.20, 0.15, -19, 0.389016, 0.17698},
        {110, 8, (double) INT2_MAX, 0.0292, 0.046, 0.17, 0.17, -23, 0.389016, 0.17698},
        {105, 8, (double) INT2_MAX, 0.0280, 0.035, 0.14, 0.20, -31, 0.389016, 0.17698},
        {100, 8, (double) INT2_MAX, 0.0266, 0.026, 0.12, 0.23, -37, 0.389016, 0.17698},
        {125, 7, (double) INT2_MAX, 0.0306, 0.058, 0.22, 0.14, -18, 0.389016, 0.17698},
        {120, 7, (double) INT2_MAX, 0.0300, 0.052, 0.19, 0.16, -23, 0.389016, 0.17698},
        {115, 7, (double) INT2_MAX, 0.0292, 0.044, 0.17, 0.17, -24, 0.389016, 0.17698},
        {110, 7, (double) INT2_MAX, 0.0279, 0.032, 0.14, 0.20, -31, 0.389016, 0.17698},
        {105, 7, (double) INT2_MAX, 0.0267, 0.026, 0.11, 0.24, -41, 0.389016, 0.17698},
        {120,10,5, 0.0298, 0.049, 0.19, 0.16, -21, 0.389016, 0.17698},
        {115,10,5, 0.0290, 0.042, 0.16, 0.18, -25, 0.389016, 0.17698},
        {110,10,5, 0.0279, 0.033, 0.13, 0.21, -32, 0.389016, 0.17698},
        {105,10,5, 0.0264, 0.024, 0.10, 0.26, -46, 0.389016, 0.17698},
        {100,10,5, 0.0250, 0.018, 0.081, 0.31, -56, 0.389016, 0.17698},
        {125,10,4, 0.0301, 0.053, 0.18, 0.17, -25, 0.389016, 0.17698},
        {120,10,4, 0.0292, 0.043, 0.15, 0.20, -33, 0.389016, 0.17698},
        {115,10,4, 0.0282, 0.035, 0.13, 0.22, -36, 0.389016, 0.17698},
        {110,10,4, 0.0270, 0.027, 0.11, 0.25, -41, 0.389016, 0.17698},
        {105,10,4, 0.0254, 0.020, 0.079, 0.32, -60, 0.389016, 0.17698},
        {130,10,3, 0.0300, 0.051, 0.17, 0.18, -27, 0.389016, 0.17698},
        {125,10,3, 0.0290, 0.040, 0.13, 0.22, -38, 0.389016, 0.17698},
        {120,10,3, 0.0278, 0.030, 0.11, 0.25, -44, 0.389016, 0.17698},
        {115,10,3, 0.0267, 0.025, 0.092, 0.29, -52, 0.389016, 0.17698},
        {110,10,3, 0.0252, 0.018, 0.070, 0.36, -70, 0.389016, 0.17698},
        {135,10,2, 0.0292, 0.040, 0.13, 0.22, -35, 0.389016, 0.17698},
        {130,10,2, 0.0283, 0.034, 0.10, 0.28, -51, 0.389016, 0.17698},
        {125,10,2, 0.0269, 0.024, 0.077, 0.35, -71, 0.389016, 0.17698},
        {120,10,2, 0.0253, 0.017, 0.059, 0.43, -90, 0.389016, 0.17698},
        {115,10,2, 0.0234, 0.011, 0.043, 0.55, -121, 0.389016, 0.17698},
        {100,14,3, 0.0258, 0.023, 0.087, 0.33, -59, 0.389016, 0.17698},
        {105,13,3, 0.0263, 0.024, 0.085, 0.31, -57, 0.389016, 0.17698},
        {110,12,3, 0.0271, 0.028, 0.093, 0.29, -54, 0.389016, 0.17698},
        {115,11,3, 0.0275, 0.030, 0.10, 0.27, -49, 0.389016, 0.17698},
        {125,9,3, 0.0283, 0.034, 0.12, 0.23, -38, 0.389016, 0.17698},
        {130,8,3, 0.0287, 0.037, 0.12, 0.23, -40, 0.389016, 0.17698},
        {125,7,3, 0.0287, 0.036, 0.12, 0.24, -44, 0.389016, 0.17698},
        {140,6,3, 0.0285, 0.033, 0.12, 0.23, -40, 0.389016, 0.17698},
        {105,14,3, 0.0270, 0.028, 0.10, 0.27, -46, 0.389016, 0.17698},
        {110,13,3, 0.0279, 0.034, 0.10, 0.27, -50, 0.389016, 0.17698},
        {115,12,3, 0.0282, 0.035, 0.12, 0.24, -42, 0.389016, 0.17698},
        {120,11,3, 0.0286, 0.037, 0.12, 0.24, -44, 0.389016, 0.17698},
};
...
BlastScoreUtils::BlastStat BlastScoreUtils::getAltschulStatsForMatrix(std::string matrix, long gapOpen, long gapExtend, bool gapped) {
        double (*mat)[10];
        long val;
                ...
                if ((fabs(mat[i][0] - ((double) gapOpen)) < 0.1) &&
                    (fabs(mat[i][1] - ((double) gapExtend)) < 0.1)) {
                        if(gapped){
                                ...
                                return BlastStat(mat[i][8], mat[i][9], mat[i][5], mat[i][6], mat[i][7]);
                        }
                }
        }
        Debug(Debug::ERROR) << "Could not find statistics for " << matrix << " gapopen " << gapOpen << " and gapextend " << gapExtend << "\n";
