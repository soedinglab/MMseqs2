...
public:
    ...
    static void generateSubMatrix(double ** probMatrix, float ** subMatrixPseudoCounts, short ** subMatrix, double ** subMatrixDouble, int size, double bitFactor = 1.0, double scoringBias = 0.0);
