...
Parameters::Parameters():
        ...
        // taxonomyreport
        PARAM_REPORT_MODE(PARAM_REPORT_MODE_ID, "--report-mode", "Report mode", "Taxonomy report mode 0: Kraken 1: Krona 2: Kraken per query database", typeid(int), (void *) &reportMode, "^[0-2]{1}$"),
        // createtaxdb
