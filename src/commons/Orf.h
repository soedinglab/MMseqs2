...
public:
    ...
    static Matcher::result_t getFromDatabase(const size_t id, DBReader<KeyType> & contigsReader, DBReader<KeyType> & orfHeadersReader, int thread_idx);
    ...
    static size_t writeOrfHeader(char *buffer, KeyType key, size_t fromPos, size_t toPos, bool hasIncompleteStart,
