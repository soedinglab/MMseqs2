...
//}
    ...
    DBReader<KeyType> msaReader(msaData.c_str(), msaIndex.c_str(), par.threads, mode);
    msaReader.open(DBReader<KeyType>::LINEAR_ACCCESS);
...
#pragma omp for schedule(dynamic, 1)
        for (size_t id = 0; id < msaReader.getSize(); ++id) {
            ...
            KeyType queryKey = msaReader.getDbKey(id);
 ...
 */
    ...
    DBReader<KeyType>::softlinkDb(par.db1, par.db2, (DBFiles::Files)(DBFiles::LOOKUP | DBFiles::SOURCE));
