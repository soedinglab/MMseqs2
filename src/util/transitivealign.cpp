...
#pragma omp parallel
        {
            ...
            Matcher matcher(querySeqType, -1, par.maxSeqLen, subMat, &evaluer, par.compBiasCorrection, par.gapOpen.values.aminoacid(), par.gapExtend.values.aminoacid(), par.zdrop);
