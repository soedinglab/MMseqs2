...
// Main tools (for non-experts)
        ...
        {"createdb",             createdb,             &par.createdb,             COMMAND_MAIN,
                ...
                "<i:fastaFile1[.gz]> ... <i:fastaFileN[.gz]>|<i:stdin> <o:sequenceDB>",
                CITATION_MMSEQS2, {{"fast[a|q]File[.gz|bz]|stdin",  DbType::ACCESS_MODE_INPUT,  DbType::NEED_DATA | DbType::VARIADIC,  &DbValidator::flatfileAndStdin },
        ...
        {"easy-search",          easysearch,           &par.easysearchworkflow,   COMMAND_EASY,
                ...
                "<i:queryFastaFile1[.gz]> ... <i:queryFastaFileN[.gz]>|<i:stdin> <i:targetFastaFile[.gz]>|<i:targetDB> <o:alignmentFile> <tmpDir>",
                CITATION_SERVER | CITATION_MMSEQS2,{{"queryFastaFile[.gz]",  DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC,  &DbValidator::flatfileAndStdin },
...
// Taxonomy
        ...
        {"aggregatetax",          aggregatetax,          &par.aggregatetax,          COMMAND_TAXONOMY,
                "Aggregate taxonomic results according to sets.",
                "Use per-sequence taxonomic assignments to assign taxonomy to the entire set.",
                "Eli Levy Karin <eli.levy.karin@gmail.com>",
                "<i:taxDB> <i:setToSeqMap> <i:taxResPerSeqDB> <o:taxResPerSetDB>",
                CITATION_MMSEQS2, {{"taxDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::NEED_TAXONOMY, &DbValidator::taxSequenceDb },
...
// Utility tools to manipulate DBs
        ...
        {"swapdb",               swapdb,               &par.swapdb,               COMMAND_DB,
                "Create a DB where the key is from the first column of the input DB",
                NULL,
                "Martin Steinegger <martin.steinegger@mpibpc.mpg.de>, Clovis Galiez & Eli Levy Karin",
...
// Special-purpose utilities
        ...
        {"concatdbs",            concatdbs,            &par.concatdbs,            COMMAND_SPECIAL,
                "Concatenate two DBs, giving new IDs to entries from 2nd input DB",
