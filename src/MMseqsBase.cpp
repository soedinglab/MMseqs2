...
std::vector<Command> baseCommands = {
        ...
        {"lin8-align2clustmulti", lin8align2clustmulti, &par.lin8align2clustmulti, COMMAND_CLUSTER,
                ...
                CITATION_MMSEQS2, {{"alignedPairs", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                                           {"prefPairs", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                                           {"acceptedPairs", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile }}},
        ...
        {"lin8-pickrepprofile", lin8pickrepprofile, &par.lin8pickrepprofile, COMMAND_CLUSTER,
                "pickrepprofile on the one shot alignments: the most profile consistent member becomes the representative",
                "mmseqs lin8-pickrepprofile db clu_accepted clu clu.switched\n",
                "Gyuri Kim <gyuribio@snu.ac.kr>",
                "<i:sequenceDB> <i:acceptedPairs> <i:clusterDB> <o:clusterDB>",
                CITATION_MMSEQS2, {{"sequenceDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                           {"acceptedPairs", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
        ...
        {"lin8-monitor", lin8monitor, &par.lin8monitor, COMMAND_CLUSTER,
                "Sample CPU, memory, I/O and network of a process tree from /proc into a TSV until the root process exits",
                "mmseqs lin8-monitor run.monitor.tsv --monitor-pid $$ --monitor-interval 5 &\n",
                "Gyuri Kim <gyuribio@snu.ac.kr>",
                "<o:tsvFile>",
                CITATION_MMSEQS2, {{"tsvFile", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile }}},
