...
// multi hit search
        ...
        {"combinepvalperset",    combinepvalperset,    &par.combinepvalbyset,     COMMAND_MULTIHIT,
                ...
                CITATION_MMSEQS2,{{"querySetDB",  DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                         {"targetSetDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                         {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::resultDb },
                                         {"pvalDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, NULL},//&DbValidator::genericDb },
                                         {"tmpDir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory }}},
        {"mergeresultsbyset",    mergeresultsbyset,    &par.threadsandcompression,COMMAND_MULTIHIT,
                ...
                CITATION_MMSEQS2,{{"setDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, NULL},//&DbValidator::alignmentDb },
                                         {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, NULL},//&DbValidator::genericDb },
                                         {"resultDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, NULL}}},//&DbValidator::genericDb }}},
